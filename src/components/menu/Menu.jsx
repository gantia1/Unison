                    ...
                    <li>
                        <div className='menu-list'>ფიზიკური პირებისთვის
                            <div className="menu-dropdown">
                                ...
                                <div><a href='#'><img src={health} alt="health"/>ინდივიდუალური ჯამრთელობის
                                    დაზღვევა </a>
                                </div>
                                <div><a href='#'><img src={car} alt="car"/>ავტოდაზღვევა - პაკეტები</a></div>

                                <div>
                                    <a href='#'><img src={person} alt="person"/>მძღოლის
                                        პასუხისმგებლობის დაზღვევა
                                    </a>
                                </div>
                                <div><a href='#'><img src={flight} alt="flight"/>
