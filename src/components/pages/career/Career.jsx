        ...
        <div className="pages-header">
            ...
            <div className="career-content">
                <div className="career-left-side">
                    ...
                    <p> ან <span className="career-form-image"><FormImage/></span>
                        <span className="career-form-open">შეავსეთ ფორმა</span>
                    </p>
                </div>
                ...
                <div className="career-right-side">
                    ...
                    <p>
                        ...
                        მოახერხა ბაზარზე საიმედო დამსაქმებლის სახელით პოზიციონირება და გახდა სასურველი, სანდო სადაზღვევო
                    ...
                    <p>
                        ჩვენი ადამიანური რესურსების მართვის მიმართულებისთვის პრიორიტეტულია კომფორტული სამუშაო გარემოს
                        შექმნა, თანამშრომლებს შორის მოტივაციის ამაღლება, მათი უნარებისა და პოტენციალის მაქსიმალურად
                        გამოვლინების ხელშეწყობა და ზრუნვა მათ კმაყოფილებასა და განვითარებაზე. ასევე, არანაკლები
                        ყურადღება ეთმობა კომპანიის ზრდის ფონზე, თანამშრომელთა ლოიალობის შენარჩუნებას.
                    </p>
                    <p>
                        ჩვენი გუნდის გამორჩეული თვისებაა კოლეგიურობა და ძალიან პოზიტიური ურთიერთთანამშრომლობა.
            ...
            <div className="career-team">
                ...
                <div className="career-team-cards" ref={ref}>
                    ...
                    <div className={`career-team-card ${activeCard === 1 && 'active'}`} onClick={() => handleClick(1)}>
                        ...
                        <div className="career-team-text-container">
                            ...
                            <div className="career-team-text"><p>2006 წელს დაამთავრა თბილისის სახელმწიფო
                                უნივერსიტეტი-საერთაშორისო სამართლის ფაკულტეტი. ფლობს საერთაშორისო სამართლის მაგისტრის
                                ხარისხს. აქვს სადაზღვევო სექტორში მუშაობის 15 წლიანი გამოცდილება. 2004 წლიდან მუშაობს
                                სადაზღვევო კომპანია ალდაგში, სადაც მისი კარიერა კორპორატიული კლიენტების…</p></div>

                        </div>
                    </div>

                    <div className={`career-team-card ${activeCard === 2 && 'active'}`} onClick={() => handleClick(2)}>
                        <div className="career-team-image">
                            <img src={testImage} alt="testImage"/>
                        </div>
                        <div className="career-team-text-container">
                    ...
                    <div className={`career-team-card ${activeCard === 3 && 'active'}`} onClick={() => handleClick(3)}>
                        <div className="career-team-image">
                            <img src={testImage} alt="testImage"/>
                        </div>
                        <div className="career-team-text-container">
                ...
                <div className="career-team-card-footer">
                    ...
                    <p>ინფორმაცია მზღვეველის აქციების 10 პროცენტის ან 10 პროცენტზე მეტის მფლობელი უშუალო მესაკუთრის
                        შესახებ ნახვა შეგიძლიათ <Link to="#">ბმულზე.</Link></p>
                    <p> ინფორმაცია მზღვეველის მნიშვნელოვანი წილის მფლობელი ბენეფიციარი მესაკუთრის შესახებ ნახვა
