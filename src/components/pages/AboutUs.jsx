...
function AboutUs() {
    return (
        <div className="about-us">
            ...
            <div className="about-us-top-cards">
                ...
                <div className="about-us-top-card">
                    ...
                    <div className="about-us-top-card-description">
                        <div>
                            <p>უნისონი იღებს აკრედიტაციას აზერბაიჯანის სახელმწიფოს ფინანსთა სამინისტროს მიერ და ინიშნება
                ...
                <div className="about-us-top-card">
                    ...
                    <div className="about-us-top-card-description">
                        <div>
                            <p>უნისონი აზღვევს საქართველოს საჰაერო სივრცეს, იწყებს თანამშრომლობას იუსტიციის სახლთან და
            ...
            <div className="annual">
                ...
                <div className="annual-files">
                    ...
                    <div className="annual-file">
                        ...
                        <svg id="file_download_black_24dp" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                             viewBox="0 0 20 20">
